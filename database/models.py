"""
database/models.py
Fully normalized SQLAlchemy ORM models for UAIMS.
"""
...
class Teacher(Base):
    ...
    assigned_courses: Mapped[Optional[str]] = mapped_column(Text, nullable=True)  # comma separated
    status: Mapped[str] = mapped_column(String(30), default="Active")
    created_at: Mapped[dt.datetime] = mapped_column(DateTime, default=now)
...
class IssueRecord(Base):
    ...
    status: Mapped[str] = mapped_column(String(30), default="Issued")  # Issued/Returned/Overdue
...
class PrintingRecord(Base):
    ...
    color_mode: Mapped[str] = mapped_column(String(20), default="Black & White")  # or Color
    side_mode: Mapped[str] = mapped_column(String(20), default="Single Side")  # or Double Side
...
class DocumentRecord(Base):
    ...
    status: Mapped[str] = mapped_column(String(30), default="Pending")  # Pending/Received/Approved/Rejected
...
class PurchaseOrder(Base):
    ...
    payment_status: Mapped[str] = mapped_column(String(30), default="Unpaid")  # Paid/Unpaid/Partial
    notes: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class Notification(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    category: Mapped[str] = mapped_column(String(50), nullable=False)  # LowStock/OutOfStock/etc
